...
nancial institutions, military, federal and state government, hotels and large
corporations. 🌍

<br />
<a href="#" style="width: 100%; display: flex; justify-content: center;">
  <img src="./Login.png" alt="AMD"/>
</a>
<br />

## 📚 Features

What this code base offers:
...
- [AMD Facility Manager](#amd-facility-manager)
  - [📚 Features](#-features)
...
If you're looking to build your project or simply want to share your thoughts about the project, we encourage you to join our contact us community. Here's the link: [blumentech.dev@gmail.com](blumentech.dev@gmail.com). It's a space where we exchange ideas and help one another. Everyone's input is appreciated, and we look forward to welcoming you.
